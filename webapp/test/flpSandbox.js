		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "구매오",
									"targetURL": "#synczc507order-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczc507order-display": {
								"semanticObject": "synczc507order",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zc507order",
									"url": sap.ui.require.toUrl("sync/zc507order")
								}
							}
						}
					}
